    ...
    if($("body").hasClass("switch-scheme")){
     ...
     jQuery("#dark-mode").on("click", function() {
        if(jQuery('body').hasClass('dark-scheme')){
            window.location.href = 'https://madebydesignesia.com/themes/gigaland/index.html';
        }else{
            window.location.href = 'https://madebydesignesia.com/themes/gigaland/02_dark-index.html';
        }
     });
